class PostDAO {
    ...
    //Hacer un post con Set crea un nuevo registro
    add (post, id) {
    ...
    //Para realizar varias operaciones (modificar, publicar, etc..) al mismo tiempo , usamos batch
    batch () {
    ...
    //Agrega un nuevo campo a un registro ya creado
